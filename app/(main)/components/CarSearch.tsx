    ...
    const CarSearch = () => {
        ...
        return (
            <div className="flex md:flex-row flex-col w-full h-full gap-3 overflow-hidde">
                {/* Sidebar de filtros */}
                <div className="md:max-w-[300px] w-full surface-card p-4 shadow-2 border-round overflow-auto">
